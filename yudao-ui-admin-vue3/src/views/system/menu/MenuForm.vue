...
const submitForm = async () => {
  ...
  try {
    ...
    const data = {
      ...formData.value,
      visible: Boolean(formData.value.visible),
      keepAlive: Boolean(formData.value.keepAlive),
      alwaysShow: Boolean(formData.value.alwaysShow)
    } as unknown as MenuApi.MenuVO
