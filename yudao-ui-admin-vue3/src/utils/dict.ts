...
export enum DICT_TYPE {
  ...
  // IoT 报警主机 - 防区/分区状态与报警状态
  IOT_ZONE_ARM_STATUS = 'iot_zone_arm_status', // 防区布防状态：0撤防 1布防 2旁路
  IOT_PARTITION_ARM_STATUS = 'iot_partition_arm_status', // 分区布防状态：0撤防 1布防 2居家布防
