...
import static com.jokeep.business.DHSDK.constant.SDKStructureFieldLenth.MAX_ADDRESS_LEN;
import static com.jokeep.business.DHSDK.constant.SDKStructureFieldLenth.MAX_PASSWORD_LEN;
...
public class CFG_ACCESS_GENERAL_INFO extends NetSDKLib.SdkStructure {
  ...
  /** 门禁通道单双向配置,对应枚举{@link com.jokeep.business.DHSDK.enumeration.CFG_ACCESS_PROPERTY_TYPE} */
