...
//import static com.jokeep.business.NetSDK.demo.AudioTest.StartVoiceCom;
//import static com.jokeep.business.NetSDK.demo.AudioTest.StopVoiceCom;
...
//
//            if(type.equals("0")){
//                StartVoiceCom(lUserID);
//                data="开启通话";
//            }
//            else {
//                StopVoiceCom(lUserID);
//                data="关闭通话";
//            }
//
//        return data;
...
//    }
    ...
    public String setAlarmLight(JSONObject jsonObject) {
        ...
        try {
            ...
            if(type.equals("0")){
                hCNetSDK.NET_DVR_PTZControl_Other(lUserID,HCNetlDChannel,Integer.valueOf(jsonObject.getString("Command")),0);
                System.out.println(hCNetSDK.NET_DVR_GetLastError());
                data="开启灯光";
            }
            else {
                hCNetSDK.NET_DVR_PTZControl_Other(lUserID,HCNetlDChannel,Integer.valueOf(jsonObject.getString("Command")),1);
                System.out.println(hCNetSDK.NET_DVR_GetLastError());
                data="关闭灯光";
            }
