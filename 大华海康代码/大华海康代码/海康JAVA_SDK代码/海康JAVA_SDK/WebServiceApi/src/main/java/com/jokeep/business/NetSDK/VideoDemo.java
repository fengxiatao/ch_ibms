...
import static com.jokeep.business.NetSDK.ClinetDemo.hCNetSDK;
import static com.jokeep.business.NetSDK.ClinetDemo.playControl;
...
public class VideoDemo {
    ...
    static String resultFileName = "..\\WebServiceApi\\Download" + new String("returnFile" + ".h264");
    ...
    public static void RealPlay(int userID, int iChannelNo) {
        ...
        /*boolean b1 = hCNetSDK.NET_DVR_SaveRealData(lPlay, "..\\MediaManagerServer\\WebServiceApi\\out\\test1.mp4");
        System.out.println("捕获数据并存放到指定的文件中"+b1);
        System.out.println("捕获数据并存放到指定的文件中"+hCNetSDK.NET_DVR_GetLastError());*/
        //设置裸码流回调函数
/*        if (fPlayescallback==null)
        ...
        try {
            Thread.sleep(30000);
            /*boolean b = hCNetSDK.NET_DVR_StopSaveRealData(lPlay);
            System.out.println("停止数据捕获"+b);
            System.out.println("停止数据捕获"+hCNetSDK.NET_DVR_GetLastError());*/
    ...
    public static void getPicbyPlayCtrl(){
        ...
        try {
            ...
            fout = new FileOutputStream(System.getProperty("user.dir") + "//WebServiceApi//pic//" + newName + ".jpg");
            //将字节写入文件
            long offset = 0;
    ...
    {
        file = new File(System.getProperty("user.dir") + "\\WebServiceApi\\Download\\Videodatabytime.mp4");  //保存回调函数的音频数据
        ...
        net_dvr_vod_para.struBeginTime.dwMonth=5;
        net_dvr_vod_para.struBeginTime.dwDay=26;
        net_dvr_vod_para.struBeginTime.dwHour=15;
        net_dvr_vod_para.struBeginTime.dwMinute=30;
        net_dvr_vod_para.struBeginTime.dwSecond=00;
        //停止时间
        net_dvr_vod_para.struEndTime.dwYear=2022;
        net_dvr_vod_para.struEndTime.dwMonth=5;
        net_dvr_vod_para.struEndTime.dwDay=28;
        net_dvr_vod_para.struEndTime.dwHour=15;
        net_dvr_vod_para.struEndTime.dwMinute=35;
    ...
    {
        file = new File(System.getProperty("user.dir") + "\\WebServiceApi\\Download\\Videodatabyfile.mp4");  //保存回调函数的音频数据
    ...
    public static void DownloadRecordByFile(int userID, int iChannelNo)
    {
        ...
        //按文件下载录像
        String SaveDir=System.getProperty("user.dir") +"\\WebServiceApi\\Download\\test.mp4";
...
/*        IntByReference intP=new IntByReference(30*1024);
    ...
    public  void DowmloadRecordByTime(int userID, int iChannelNo)
    {
        ...
        net_dvr_playcond.struStartTime.dwMonth=5;
        ...
        net_dvr_playcond.struStopTime.dwMonth=5;
        net_dvr_playcond.struStopTime.dwDay=28;
        ...
        String sFileName = System.getProperty("user.dir") +"\\WebServiceApi\\Download\\" + System.currentTimeMillis() + ".mp4";
