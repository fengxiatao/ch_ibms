...
public class NetClient {
	...
	public static int CmdConfig(int mILogonID, int cmdNorthAngle, int iChan,
			NorthAngle tInPara, int iInSize, NorthAngle tInfo, int iOutSize) {
		return nvssdk.NetClient_CmdConfig(mILogonID, cmdNorthAngle, iChan, tInPara, iInSize, tInfo, iOutSize);
	}
		
	public static int VCAGetAlarmInfo(int _iLogonID, int _iAlarmIndex, Pointer _lpBuf, int _iBufSize) {
		return nvssdk.NetClient_VCAGetAlarmInfo(_iLogonID, _iAlarmIndex, _lpBuf, _iBufSize);
	}
}
