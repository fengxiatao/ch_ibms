...
private:
	...
	void ResetQuery();
	void Update_UI_DualUsersAuthButtonState();
    ...
    void PlaybackByFile(int iDirection);
...
public:
	...
	CComboBox m_VCAdetailType;
	CComboBox m_VCADiskNo;
	CComboBox m_VCADiskGroup;
...
public:
	CComboBox m_cboFileAtrr;
    afx_msg void OnBnClickedButtonPlaybackByFileReverse();
	afx_msg void OnBnClickedButtonFileCheckvod();
	afx_msg void OnCbnSelchangeComboReqMode();
	afx_msg void OnCbnSelchangeComboDlTimeout();
	CComboBox m_cboDLTimeOut;
	afx_msg void OnBnClickedButtonDualusersAuth();
