...
int CLS_DownloadFile::GetIframeFlag()
{
	return m_iIframe;
}

int CLS_DownloadFile::SetIframeFlag(int _iFlag)
{
	m_iIframe = _iFlag;
	return 0;
}
...
void CLS_DownloadFile::SetFileSize(unsigned int _iFileSize)
{
	m_iFileSize = _iFileSize;
}

unsigned int CLS_DownloadFile::GetFileSize()
{
	return m_iFileSize;
}