...
int CIniFile::ReadString( char* _szSection, char* _szKey, char* _szValue, int iValLen, char* _szDefaultValue)
{
    if (strcmp(m_cFilePath, "") != 0)
    {
        GetPrivateProfileString(_szSection, _szKey, _szDefaultValue, _szValue, iValLen, m_cFilePath);
    }
    return 0;
}
