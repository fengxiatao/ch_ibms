...
public:
	...
	CButton m_chkAll;
	CButton m_chkNet;
	CButton m_chkStorage;
	CButton m_chkEvent;
	CButton m_chkSystem;
	CButton m_chkChannel;
	CButton m_chkPreview;
	void UpdateAllSelectBtn();
	afx_msg void OnBnClickedCheckSetAll();
	afx_msg void OnBnClickedCheckSetNet();
	afx_msg void OnBnClickedCheckStorage();
	...
	afx_msg void OnBnClickedButtonAdvSysDelete();
	CButton m_Button_Delete;
	CComboBox m_cboCommonDefault;
	afx_msg void OnBnClickedButtonCommonDefault();
	CButton m_chkCapImg;
	CButton m_chkAnalysisImg;
	CButton m_chkInfrarImg;
	CButton m_chkInfrarCapImg;
	afx_msg void OnBnClickedCheckAnalyssisimg();
	afx_msg void OnBnClickedCheckInfrarimg();
	afx_msg void OnBnClickedCheckInfrarcapimg();
	afx_msg void OnBnClickedCheckCapimg();
	afx_msg void OnBnClickedButtonGetDevTime();
