...
#define REPORT_QUERY_POSITIVE	1	//Report query - positive sequence
#define REPORT_QUERY_REVERSE	2	//Report query - reverse order
...
public:
	...
	CComboBox m_cboReportQueryType;		//Report query type
private:
