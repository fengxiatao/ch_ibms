...
public:
	...
	void SetArithmeticType(int _iType);
	void JudgeVCASetState(bool bIsVcaSet);
	void JudgeVCAStatus();
private:
	...
	int m_iReferCount;
	CEdit m_edtGaugeLength;
	int m_iArithmeticType;
public:
	...
	afx_msg void OnCbnSelchangeComboWldGaugetype();
	afx_msg void OnStnClickedStaticWldPresetSceneTotalCount();
	CComboBox m_cboGaugedMode;
	afx_msg void OnBnClickedButtonGaugedLineDraw();
	CEdit m_edtGaugedLine;
	CButton m_chkSnapEnable;
	CComboBox m_cboSnapNo;
};
