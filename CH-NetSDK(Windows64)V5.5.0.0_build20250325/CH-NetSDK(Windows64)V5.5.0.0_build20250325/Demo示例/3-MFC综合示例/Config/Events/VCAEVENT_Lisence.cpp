...
//	"Chuan (Sichuan)", "E (Hubei)", "Gan (Jiangxi)", "Gan (Gansu)", "Hanging", "Gui (Guangxi)",
//	"Gui (Guizhou)", "Black (Heilongjiang)", "Shanghai (Shanghai)", "Hebei (Hebei)", "Ji (Jilin)", "Jin (Shanxi)",
//	"Tianjin (Tianjin)", "Jing (Beijing)", "Police", "Army", "Empty", "Liaoning (Liaoning)",
//	"Lu (Shandong)", "Mongolia (Inner Mongolia)", "Min (Fujian)", "Ning (Ningxia)", "Qian (Guizhou)", "Qing (Qinghai)",
//	"Qiong (Hainan)", "Shaanxi (Shaanxi)", "Shu (Sichuan)", "Su (Jiangsu)", "Taiwan (Taiwan)", "Wan (Anhui)",
//	"Xiang (Hunan)", "Xin (Xinjiang)", "Chongqing (Chongqing)", "Yu (Henan)", "Guangdong (Guangdong)", "Cloud (Yunnan)",
//	"Tibet (Tibet)", "Zhejiang (Zhejiang)"
//};

const CString CONST_cstrProvince[] ={
	"Chuan", "E", "Gan", "Gan", "Hang", "Gui",
	"Gui", "Black", "Shanghai", "Ji", "Ji", "Jin",
	"Jin", "Jing", "Police", "Army", "Empty", "Liao",
	"Lu", "Mongolia", "Min", "Ning", "Qian", "Qing",
	"Qiong", "Shaanxi", "Shu", "Su", "Taiwan", "Wan",
	"Xiang", "Xin", "Yu", "Yu", "Guangdong", "Cloud",
	"Tibetan", "Zhejiang"
};
...
// CLS_VCAEVENT_Lisence message handler
...
void CLS_VCAEVENT_Lisence::OnBnClickedBtnLisenceSet()
{
	...
	//Save the polygon point coordinates with the high 16 bits as the Y coordinate and the low 16 bits as the X coordinate, and the four-point quadrilateral.
