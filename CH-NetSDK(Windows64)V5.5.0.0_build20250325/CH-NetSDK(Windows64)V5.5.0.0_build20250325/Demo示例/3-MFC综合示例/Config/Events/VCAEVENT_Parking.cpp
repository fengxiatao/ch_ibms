// LS_VCAEVENT_Parking.cpp : Implementation file
//
...
#define	LEN_3						3
#define LEN_5						5
#define POINT_SUM					4		//Number of points in the drawn area
#define MIN_TIME_FROM				0		//The duration of triggering the parking alarm (seconds), the minimum value
#define MIN_TIME_TO					30		//The duration of triggering the parking alarm (seconds), the maximum value
#define MIN_TIME_DEFAULT			5		//Duration (seconds) to trigger parking alarm, default value
#define MIN_SIZE_FROM				0		//minimum size, minimum value
#define MIN_SIZE_TO					100		//minimum size, maximum value
#define MIN_SIZE_DEFAULT			5		//minimum size, default value
#define MAX_SIZE_FROM				0		// max size, min
#define MAX_SIZE_TO					100		//max size, max value
#define MAX_SIZE_DEFAULT			30		//max size, default value
#define SPEED_THRESHOLD_FROM		0		// max size, min
#define SPEED_THRESHOLD_TO			100		//max size, max value
#define SPEED_THRESHOLD_DEFAULT		30		//max size, default value
...
// CLS_VCAEVENT_Parking message handler
...
void CLS_VCAEVENT_Parking::OnEnChangeEdtParkSpeedShrehold()
{
	...
	int iDotCount = 0;
	// There can be no more than one dot character, and there can only be one digit after the decimal point
	...
	// Characters other than numbers and dots are not allowed
	for (int iIndex = 0; iIndex < iStringLength; iIndex++)
	{
