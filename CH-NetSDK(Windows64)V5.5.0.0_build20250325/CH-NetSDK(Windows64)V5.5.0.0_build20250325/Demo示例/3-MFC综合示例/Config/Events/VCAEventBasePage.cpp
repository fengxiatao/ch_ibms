...
void CLS_VCAEventBasePage::OnParamChangeNotify( int _iLogonID, int _iChannelNo, int _iParaType,void* _pPara,int _iUser )
{
	return;
}
...
void CLS_VCAEventBasePage::SetDevType(int _iDevType)
{
