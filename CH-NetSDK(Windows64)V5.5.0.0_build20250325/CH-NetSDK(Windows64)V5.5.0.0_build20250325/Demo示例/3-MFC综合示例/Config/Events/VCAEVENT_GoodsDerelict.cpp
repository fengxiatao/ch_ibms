// VCAEVENT_GoodsDerelict.cpp : Implementation file
//
...
#define POINT_SUM					4			// number of points
#define CHILD_AREA_SUM				3			//Number of sub-areas
#define MAIN_AREA					0			// main area number
#define CHILD_AREA_1				1			//Sub area 1 number
#define CHILD_AREA_2				2			//Sub area 2 number
#define CHILD_AREA_3				3			//Sub area 3 number

#define MIN_TIME_DEFAULT			5000		//The default value of the shortest time
#define MIN_SIZE_DEFAULT			10			//Default minimum pixel size
#define MAX_SIZE_DEFAULT			10000		//Maximum pixel size default value
