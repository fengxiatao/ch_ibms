...
public:
	CLS_VCAEVENT_PersonStat(CWnd* pParent = NULL);   // Standard constructor
...
public:
	...
	afx_msg void OnBnClickedButtonClearCpcadvance();
	afx_msg void OnCbnSelchangeComboScene();
	int m_iTimeout;
	CComboBox m_cboDisplayRule;
	CComboBox m_cboDisplayInfo;
};
