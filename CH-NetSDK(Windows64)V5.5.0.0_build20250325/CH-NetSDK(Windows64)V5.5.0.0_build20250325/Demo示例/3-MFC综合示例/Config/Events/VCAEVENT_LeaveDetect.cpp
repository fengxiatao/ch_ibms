...
void CLS_VCAEVENT_LeaveDetect::OnBnClickedButtonLeavedetectSet()
{
	...
	GetPolyFromStringEx(strArea1PointStr, iArea1PointNum, tLeaveDetect->stRegion[0]);
	...
	GetPolyFromStringEx(strArea2PointStr, iArea2PointNum, tLeaveDetect->stRegion[1]);
	...
	GetPolyFromStringEx(strArea3PointStr, iArea3PointNum, tLeaveDetect->stRegion[2]);
	...
	GetPolyFromStringEx(strArea4PointStr, iArea4PointNum, tLeaveDetect->stRegion[3]);
	...
	else
	{
		...
		RestartVCALib(m_iLogonID, m_iChannelNO);//Restart the smart library
	}
}
