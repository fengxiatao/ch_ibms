// VCAEVENT_VideoDetectNew.cpp : Implementation file
//
...
#define ALOG_TYPE_SUM			9			//Total number of algorithm types
...
#define TIME_MIN				0			// detect the minimum time
#define	TIME_MAX				5			//detect the maximum value of time
#define VIDEO_DIAGNOSE_RULEID	8			//Video diagnosis ruleid with 8
...
// CLS_VCAEVENT_VideoDetectNew message handler
...
void CLS_VCAEVENT_VideoDetectNew::UpdatePageUI()
{
	...
	vtvd.iRuleID = VIDEO_DIAGNOSE_RULEID;//Video diagnostic fixed 8
