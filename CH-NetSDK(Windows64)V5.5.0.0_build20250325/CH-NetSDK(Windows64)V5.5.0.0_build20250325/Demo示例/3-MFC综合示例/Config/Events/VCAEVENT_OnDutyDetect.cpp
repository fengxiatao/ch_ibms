// VCAEVENT_OnDutyDetect.cpp : Implementation file
//
...
// CLS_VCAEVENT_OnDutyDetect dialog
...
// CLS_VCAEVENT_OnDutyDetect message handler
...
void CLS_VCAEVENT_OnDutyDetect::UpdatePageUI()
{
	...
	else
	{
		...
		if (1 == iAlarmRule)//The alarm rule is valid
		{
		...
		if (1 == iAlarmStat)//Alarm statistics are valid
		{
		...
		if (1 == iTarget)//Target box is valid
		{
...
//Take the 4 vertices of the area and pass the two vertices of "upper left" and "lower right" to the device
