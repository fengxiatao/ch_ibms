// VCAEVENT_Running.cpp : Implementation file
//
...
BOOL CLS_VCAEVENT_Protect::OnInitDialog()
{
	...
	//TODO Without SetSize, memory will be allocated and copied frequently, resulting in inefficiency and fragmented memory
...
void CLS_VCAEVENT_Protect::UI_UpdateDialogText()
{
	...
	//Whether to limit the direction
