...
private:
	...
	st_PTZCruise m_ptzCruise;		//Auto cruise preset position information
	int m_iCruiseNum;				//The number of preset positions of the current cruise point
	CComboBox m_cboCruiseTime;
	CLS_DeviceControl m_tDevCtrl;
	int	m_iCruiseSpeed;		        //Auto cruise speed
};
