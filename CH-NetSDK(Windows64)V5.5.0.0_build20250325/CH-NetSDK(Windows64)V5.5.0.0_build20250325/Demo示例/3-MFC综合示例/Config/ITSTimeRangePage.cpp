...
void CLS_ITSTimeRangePage::UI_UpdateDialog()
{
	...
	m_cboType.AddString("20-focus mode");
	m_cboType.AddString("21-minimum focus distance");
	m_cboType.AddString("22-day and night switching");
	m_cboType.AddString("23-Restore default");
	m_cboType.AddString("24-Dehaze");
	m_cboType.AddString("25-AE adjustment speed");
	m_cboType.AddString("26-SmartIR");
	m_cboType.AddString("27-exposure compensation");
	m_cboType.AddString("28-high sensitivity");
	m_cboType.AddString("29-slow exposure");
	m_cboType.AddString("30-Auto Contrast");
	m_cboType.AddString("31-image freeze");
	m_cboType.AddString("32-IR correction");
	m_cboType.AddString("33-color gain");
	m_cboType.AddString("34-color phase");
	m_cboType.AddString("35-Low Light Color Suppression");
	m_cboType.AddString("36-focus type");
	m_cboType.AddString("37-Night Vision Enhancement");
	m_cboType.AddString("38-Vignette Processing");
