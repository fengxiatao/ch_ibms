...
// CLS_DhDebugMNL message handler
...
BOOL CLS_DhDebugKGL::UpdateDialog()
{
	...
	//m_cboInportState.SetCurSel(0);//How to get the status value?
...
{
	int iState = m_cboInportState.GetCurSel();//How to set the status value?
	AlarmInDebug tDebug = {sizeof(tDebug)};
