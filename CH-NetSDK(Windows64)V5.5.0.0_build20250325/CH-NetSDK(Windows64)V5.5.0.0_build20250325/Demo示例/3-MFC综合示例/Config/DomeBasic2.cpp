...
//Title display time: 0-off 1-continuous 2-2 seconds 3-5 seconds 4-10 seconds
...
BOOL CLS_DomeTitle::OnInitDialog()
{
	...
	// Limit the input length of the edit box to 30 bytes
...
void CLS_DomeTitle::UI_UpdateDomeTitleInfo()
{
	...
	// title background, direction display
	memset(&tParam, 0, sizeof(TDomeParam));
...
int CLS_DomeTitle::GetTitleCMDType( int _iTitleType )
{
	...
	case TITLETYPE_PRESET:
		...
		break;
	case TITLETYPE_SCAN:	//scanning
	case TITLETYPE_CRUISE:	//cruise
	case TITLETYPE_PATTERN:	// mode path
		{
