...
// CLS_LinkDevSetEdit message handler
...
BOOL CLS_LinkDevSetEdit::UpdateUI()
{
	...
	else
	{
		...
		// linkage type: 0-reservation, 1-output, 2-OSD, 3-arm, 4-disarm, 5-restore automatic control
		...
		//Linkage recovery mode 0-no recovery, 1-delayed recovery, 2-alarm recovery recovery, 3-alarm recovery delay recovery
...
void CLS_LinkDevSetEdit::OnBnClickedBtnLinkSure()
{
	...
	//Linkage type 1-output, 2-OSD, 3-arm, 4-disarm, 5-restore automatic control
	...
	//Linkage recovery mode 0-no recovery, 1-delay recovery, 2-alarm recovery recovery, 3-alarm recovery delay recovery
