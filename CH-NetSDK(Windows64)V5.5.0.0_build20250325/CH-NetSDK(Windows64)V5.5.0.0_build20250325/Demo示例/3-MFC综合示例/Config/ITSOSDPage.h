...
private:
	...
	CEdit m_edtFontWid;
	CEdit m_edtFontHigh;
	CComboBox m_cboMergePic;
	CButton m_chkMergePicTT;
	CButton m_chkMergePicTF;
public:
	afx_msg void OnCbnSelchangeCombo4();
	afx_msg void OnBnClickedBtnFontsizeset();
	afx_msg void OnCbnSelchangeCboFontsize();
	afx_msg void OnBnClickedBtnMergeSet();
};
