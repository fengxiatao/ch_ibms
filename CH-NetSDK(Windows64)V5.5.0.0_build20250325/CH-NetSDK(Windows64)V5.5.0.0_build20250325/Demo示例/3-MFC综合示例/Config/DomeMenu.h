...
private:
	CButton m_chkPsmEnable;
	CEdit m_edtInfraredLightOnTime;
	CEdit m_edtInfraredLightOffTime;
public:
	afx_msg void OnBnClickedButtonSetPsm();
	CComboBox m_cboModuleType;
