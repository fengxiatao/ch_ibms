...
private:
	...
	CSliderCtrl m_sldVideoOcclusionThreshold;
	...
	// Alarm linkage pause time interval Linkage type
...
public:
	...
	afx_msg void OnBnClickedButtonVideoOccSensitivity();
	afx_msg void OnNMCustomdrawSliderVideoOccSensitivity(NMHDR *pNMHDR, LRESULT *pResult);
};
