...
public:
	...
	afx_msg void OnBnClickedButtonModeset();
	CEdit m_edtSipPublicKey;
	CComboBox m_cboSipMode;
	afx_msg void OnBnClickedButtonKeygenerate();
	afx_msg void OnBnClickedButtonSipPcchannelset();
	void UI_UpdateSipChannel();
	CComboBox m_cboVideoPlatId;
	CComboBox m_cboAlarmPlatId;
	CComboBox m_cboAudioConnType;
	CComboBox m_cboAudioPlatId;
};
