...
public:
	...
	CComboBox m_Combo_Ipv6_Mode;
	CComboBox m_Combo_Ipv6_DnsEnable;
	CComboBox m_ComboIpv6AddrList;
	afx_msg void OnCbnSelchangeComboIpv6Mode();
	afx_msg void OnCbnSelchangeComboIpv6Dnsenable();
	afx_msg void OnBnClickedButtonIpv6Refresh();
};
