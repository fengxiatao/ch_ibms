...
public:
	...
	void ProcessQueryGettotalcount();
	void SDKQueryData();
...
private:
	...
	CEdit m_edtQueryType;
	CEdit m_edtQueryChannel;

	int m_iTotalRecordCount;   // total number of queries
	int m_iTotalPageCount;    // The interface is divided into m_iTotalPageCount page display
	int m_iCurrentPageNo;     // The current page number displayed on the interface
	int m_iBeginIndex;
	int m_iEndIndex;
