...
#define BLACKENABLE 1 //Enable the black car
#define LISENCE_PARAM_OK	100 //The progress of the import progress bar is 100, the import is successful
#define LISENCE_PARAM_ERROR -1 //Import failed
#define CURRENTSHOWCOUNT 25//Number of currently displayed bars
#define DEFAULT_PAGEID 1 //Default page number
...
CString CLS_BAWLicencePlate::GetSystemOutputPath()
{
	...
	CString strFileName;
	strFileName = m_Date.Format("%Y%m%d%H%M%S");                               //File name of exported data
