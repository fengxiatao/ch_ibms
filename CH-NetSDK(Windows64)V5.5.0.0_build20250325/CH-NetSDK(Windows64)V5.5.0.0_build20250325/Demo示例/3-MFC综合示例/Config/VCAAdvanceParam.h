...
private:
	...
	CSliderCtrl m_sldTargetCheckSensitivity;
...
public:
	...
	afx_msg void OnNMCustomdrawSldAdvParaTargetCheckSensitivity(NMHDR *pNMHDR, LRESULT *pResult);
private:
	CComboBox m_cboRecoverTime;
public:
	afx_msg void OnCbnSelchangeComboResumeTime();
	void UI_UpdateSceneResumeTime();
};
