...
public:
	CLS_VCAEvnetsSmartTrack(CWnd* pParent = NULL);   // Standard constructor
...
public:
	CEdit 		m_edtTrackMulripe;		// Tracking magnification
...
public:
	...
	CButton m_chkCallSimilarVision;
	CComboBox m_cboCheckTargetType;
