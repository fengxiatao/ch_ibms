...
//Mode path operation: 0-start, 1-end, 2-delete, 3-call
#define SCHEMA_PATH_START	0
#define SCHEMA_PATH_OVER	1
#define SCHEMA_PATH_DELETE	2
#define SCHEMA_PATH_CALL	3

//Area indication operation: 0-left border, 1-right border, 2-delete
#define AREA_BRODER_LEFT	0
#define AREA_BRODER_RIGHT	1
#define AREA_BRODER_DELETE	2

//Keyed limit settings 0 - not enabled 1 - enabled limit 2 - set limit 3 - cleared limit
