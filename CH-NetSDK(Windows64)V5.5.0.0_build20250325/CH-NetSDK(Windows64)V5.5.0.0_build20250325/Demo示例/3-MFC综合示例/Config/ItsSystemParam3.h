...
public:
	CLS_ItsSystemParam3(CWnd* pParent = NULL);   // Standard constructor
...
public:
	...
	CButton m_chkDevtype0;
	CButton m_cboDevType1;
	CButton m_chkDevType2;
	CButton m_chkDevType3;
	CButton m_chkDevType4;
	CButton m_chkDevType5;
