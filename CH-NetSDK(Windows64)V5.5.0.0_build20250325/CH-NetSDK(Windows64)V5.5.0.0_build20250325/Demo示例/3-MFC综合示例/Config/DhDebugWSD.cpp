...
// CLS_DhDebugWSD message handler
...
//	int iTemperature = GetDlgItemInt(IDC_EDT_WSD_TEMPERATURE);//How to set the value?
	int iHumiture = GetDlgItemInt(IDC_EDT_WSD_HUMIDITY);//How to set the value?
	AlarmInDebug tDebug = {sizeof(tDebug)};
