// ls_ItsStateQuery.cpp : Implementation file
//
...
#define  LOOP_STATUS_EMPTY			0				//coil trigger status - empty
#define  LOOP_STATUS_ENTER			1				//coil trigger state - enter
#define  LOOP_STATUS_LEAVE			2				//coil trigger turntable - leave
...
// Cls_ItsStateQuery message handler
				...
				case ITS_TEMPRETURE :
					{
						...
						CString cstrTemp;
						cstrTemp.Format("%.1fdegree", fTemp);
