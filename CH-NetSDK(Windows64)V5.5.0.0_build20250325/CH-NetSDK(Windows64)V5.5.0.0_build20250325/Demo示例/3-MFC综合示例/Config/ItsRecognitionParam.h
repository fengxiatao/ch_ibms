...
public:
	...
	afx_msg void OnEnChangeEditFirstCh();
	void UI_UpdateEBike();
	CComboBox m_cboEbikeCity;
	afx_msg void OnBnClickedButtonEbikeSet();
	CButton m_chkEbikeEnable;
	afx_msg void OnCbnSelchangeComboEbikeCity();
};
