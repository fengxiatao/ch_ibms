...
private:
	...
	int		m_iLeft;	//Left Margin - Top Left X coordinate
	int		m_iTop;	//Top Margin - Y coordinate of upper left corner
	int		m_iRight;	//Right Margin - X coordinate of bottom right corner
	int		m_iBottom;	//Bottom Margin - Y coordinate of bottom right corner
