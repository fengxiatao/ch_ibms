// ItsRoadwayCommon4.cpp : Implementation file
//

#include "stdafx.h"
#include "NetClientDemo.h"
#include "ItsRoadwayCommon4.h"
#define ITS_NUM_MAX 20 // maximum number of array cCoordinate

// CLS_ItsRoadwayCommon4 dialog
...
// CLS_ItsRoadwayCommon4 message handler
...
void CLS_ItsRoadwayCommon4::UI_UpdateDialog()
{
	...
	//Fill in the description of the capture location
	//0 - do not capture
	//1 - Snapshot when entering the speed coil
	//2 - Snapshot when leaving the speed coil
	//3 - Capture when entering the capture coil
	//4 - capture when leaving the capture coil
	//5 - Delayed capture
	// by type, for example: 1,2,3,4
