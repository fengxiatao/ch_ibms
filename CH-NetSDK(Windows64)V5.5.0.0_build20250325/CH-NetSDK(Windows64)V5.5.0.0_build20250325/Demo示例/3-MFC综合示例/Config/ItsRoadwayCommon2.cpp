// ItsRoadwayCommon2.cpp : Implementation file
//
...
void CLS_ItsRoadwayCommon2::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_CHECK_BAYONETENABLE, m_ChkBayonetEnable);
}
...
// CLS_ItsRoadwayCommon2 message handler
...
void CLS_ItsRoadwayCommon2::UI_UpdateDialog()
{
	...
	SetDlgItemText(IDC_STA_ROADWAY_BOUNDARY_SCENEID, GetTextByLan("场景号", "SceneID"));
	SetDlgItemText(IDC_STA_ROADWAY_BOUNDARY_MOVETHRESHOLD, GetTextByLan("行人位移灵敏度", "PeopleMoveThreshold"));
	SetDlgItemText(IDC_CHECK_BAYONETENABLE, GetTextByLan("开启卡口", "BayonetEnable"));
	SetDlgItemText(IDC_STA_SPE_USE2, GetTextByLan("专用车道时间段2", "Special Use2"));
	SetDlgItemText(IDC_STA_SPE_USE3, GetTextByLan("专用车道时间段3", "Special Use3"));
	SetDlgItemText(IDC_STA_SPE_USE4, GetTextByLan("专用车道时间段4", "Special Use4"));
...
void CLS_ItsRoadwayCommon2::OnBnClickedBtnCarProperty()
{
	...
	char cTimeRange2[20] = {0};
	GetDlgItemText(IDC_EDT_SPE_USE_START2, cTimeRange2, 20);
	sscanf_s(cTimeRange2, "%2d:%2d-%2d:%2d", &iBeginHour, &iBeginMinute, &iEndHour, &iEndMinute);
	tItsRoadwayInfo_V1.stStartTime2.iYear =  tTime.GetYear();
	tItsRoadwayInfo_V1.stStartTime2.iMonth = tTime.GetMonth();
	tItsRoadwayInfo_V1.stStartTime2.iDay = tTime.GetDay();
	tItsRoadwayInfo_V1.stStartTime2.iHour =  iBeginHour;
	tItsRoadwayInfo_V1.stStartTime2.iMinute = iBeginMinute;

	tItsRoadwayInfo_V1.stStopTime2.iYear =  tTime.GetYear();
	tItsRoadwayInfo_V1.stStopTime2.iMonth = tTime.GetMonth();
	tItsRoadwayInfo_V1.stStopTime2.iDay = tTime.GetDay();
	tItsRoadwayInfo_V1.stStopTime2.iHour =  iEndHour;
	tItsRoadwayInfo_V1.stStopTime2.iMinute = iEndMinute;

	char cTimeRange3[20] = {0};
	GetDlgItemText(IDC_EDT_SPE_USE_START3, cTimeRange3, 20);
	sscanf_s(cTimeRange3, "%2d:%2d-%2d:%2d", &iBeginHour, &iBeginMinute, &iEndHour, &iEndMinute);
	tItsRoadwayInfo_V1.stStartTime3.iYear =  tTime.GetYear();
	tItsRoadwayInfo_V1.stStartTime3.iMonth = tTime.GetMonth();
	tItsRoadwayInfo_V1.stStartTime3.iDay = tTime.GetDay();
	tItsRoadwayInfo_V1.stStartTime3.iHour =  iBeginHour;
	tItsRoadwayInfo_V1.stStartTime3.iMinute = iBeginMinute;

	tItsRoadwayInfo_V1.stStopTime3.iYear =  tTime.GetYear();
	tItsRoadwayInfo_V1.stStopTime3.iMonth = tTime.GetMonth();
	tItsRoadwayInfo_V1.stStopTime3.iDay = tTime.GetDay();
	tItsRoadwayInfo_V1.stStopTime3.iHour =  iEndHour;
	tItsRoadwayInfo_V1.stStopTime3.iMinute = iEndMinute;

	char cTimeRange4[20] = {0};
	GetDlgItemText(IDC_EDT_SPE_USE_START4, cTimeRange4, 20);
	sscanf_s(cTimeRange4, "%2d:%2d-%2d:%2d", &iBeginHour, &iBeginMinute, &iEndHour, &iEndMinute);
	tItsRoadwayInfo_V1.stStartTime4.iYear =  tTime.GetYear();
	tItsRoadwayInfo_V1.stStartTime4.iMonth = tTime.GetMonth();
	tItsRoadwayInfo_V1.stStartTime4.iDay = tTime.GetDay();
	tItsRoadwayInfo_V1.stStartTime4.iHour =  iBeginHour;
	tItsRoadwayInfo_V1.stStartTime4.iMinute = iBeginMinute;

	tItsRoadwayInfo_V1.stStopTime4.iYear =  tTime.GetYear();
	tItsRoadwayInfo_V1.stStopTime4.iMonth = tTime.GetMonth();
	tItsRoadwayInfo_V1.stStopTime4.iDay = tTime.GetDay();
	tItsRoadwayInfo_V1.stStopTime4.iHour =  iEndHour;
	tItsRoadwayInfo_V1.stStopTime4.iMinute = iEndMinute;
	...
	tItsRoadwayInfo_V1.iSceneID = GetDlgItemInt(IDC_EDT_SCENEID);
	tItsRoadwayInfo_V1.iPeopleMoveThreshold = GetDlgItemInt(IDC_EDIT_MOVETHRESHOLD);
	tItsRoadwayInfo_V1.iBayonetEnable = m_ChkBayonetEnable.GetCheck();
...
void CLS_ItsRoadwayCommon2::UI_UpdateCarProperty()
{
	...
	if (0 == iRet)
	{
		...
		strTimeRange.Format("%2d:%2d-%2d:%2d", tItsRoadwayInfo_V1.stStartTime2.iHour, tItsRoadwayInfo_V1.stStartTime2.iMinute,
			tItsRoadwayInfo_V1.stStopTime2.iHour, tItsRoadwayInfo_V1.stStopTime2.iMinute);
		SetDlgItemText(IDC_EDT_SPE_USE_START2, strTimeRange);

		strTimeRange.Format("%2d:%2d-%2d:%2d", tItsRoadwayInfo_V1.stStartTime3.iHour, tItsRoadwayInfo_V1.stStartTime3.iMinute,
			tItsRoadwayInfo_V1.stStopTime3.iHour, tItsRoadwayInfo_V1.stStopTime3.iMinute);
		SetDlgItemText(IDC_EDT_SPE_USE_START3, strTimeRange);

		strTimeRange.Format("%2d:%2d-%2d:%2d", tItsRoadwayInfo_V1.stStartTime4.iHour, tItsRoadwayInfo_V1.stStartTime4.iMinute,
			tItsRoadwayInfo_V1.stStopTime4.iHour, tItsRoadwayInfo_V1.stStopTime4.iMinute);
		SetDlgItemText(IDC_EDT_SPE_USE_START4, strTimeRange);
		...
		SetDlgItemText(IDC_EDT_SCENEID, IntToStr(tItsRoadwayInfo_V1.iSceneID).c_str());
		SetDlgItemText(IDC_EDIT_MOVETHRESHOLD, IntToStr(tItsRoadwayInfo_V1.iPeopleMoveThreshold).c_str());
		m_ChkBayonetEnable.SetCheck(tItsRoadwayInfo_V1.iBayonetEnable);
