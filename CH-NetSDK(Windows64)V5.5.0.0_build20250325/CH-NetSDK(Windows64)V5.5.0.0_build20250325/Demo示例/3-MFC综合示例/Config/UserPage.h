...
private:
	...
	CEdit m_edtMaxUser;
	CButton m_chkDualUsersAuthentication;
public:
	afx_msg void OnLbnSelchangeListUserinfo();
	afx_msg void OnBnClickedBntLogonfailLocktimeset();
	afx_msg void OnBnClickedCheckDualusersAuthentication();
};
