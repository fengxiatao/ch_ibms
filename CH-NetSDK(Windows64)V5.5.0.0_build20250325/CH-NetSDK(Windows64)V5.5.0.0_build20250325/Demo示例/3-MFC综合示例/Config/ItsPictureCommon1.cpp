...
void Cls_ItsPictureCommon1::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_COMBO_EXPOSAL_TYPE, m_cboExposalType);
}
...
void Cls_ItsPictureCommon1::UI_UpdateDialog()
{
	...
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE0)),CAMERA_PARA_IRIS_ADJUSTMENT);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE1)),CAMERA_PARA_WDR);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE2)),CAMERA_PARA_BLC);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE3)),CAMERA_PARA_EXPOSURE_TIME);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE4)),CAMERA_PARA_SHUTTER_ADJUSTMENT);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE5)),CAMERA_PARA_GAIN_ADJUSTMENT);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE6)),CAMERA_PARA_GAMMA_ADJUSTMENT);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE7)),CAMERA_PARA_SHARPNESS_ADJUSTMENT);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE8)),CAMERA_PARA_NOISE_REDUCTION_ADJUSTMENT);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE9)),CAMERA_PARA_EXPOSURE_REGION);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE10)),CAMERA_PARA_BLC_REGION);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE11)),CAMERA_PARA_AF_REGION_SET);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE12)),CAMERA_PARA_TARGET_BRIGHTNESS_ADJUSTMENT);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE13)),CAMERA_PARA_WHITE_BALANCE_ADJUSTMENT);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE14)),CAMERA_PARA_JPEG_IMAGE_QUALITY);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE15)),CAMERA_PARA_LUT_ENABLE);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE16)),CAMERA_PARA_AUTOMATIC_BRIGHTNESS_ADJUST);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE17)),CAMERA_PARA_HSBLC);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE18)),CAMERA_PARA_AUTO_EXPOSURE_MODE);
	m_cboType.SetItemData(m_cboType.AddString(GetTextEx(IDS_CONFIG_ITS_TYPE19)),CAMERA_PARA_SCENE_MODE);
	m_cboType.SetItemData(m_cboType.AddString(GetTextByLan("¿¹ÉÁ","Anti flash")),CAMERA_PARA_ANTI_FLASH);

	m_cboExposalType.ResetContent();
	m_cboExposalType.AddString(GetTextByLan("¼à¿ØÍ¼Ïñ","Monitoring image"));
	m_cboExposalType.AddString(GetTextByLan("×¥ÅÄÍ¼Ïñ","Capture image"));
	m_cboExposalType.AddString(GetTextByLan("·ÖÎöÍ¼Ïñ","Analysis image"));
	m_cboExposalType.AddString(GetTextByLan("ºìÍâ¼à¿ØÍ¼Ïñ","Infrared monitoring image"));
	m_cboExposalType.AddString(GetTextByLan("ºìÍâ×¥ÅÄÍ¼Ïñ","Infrared capture image"));
	
	SetDlgItemText(IDC_STATIC_EXPOSAL_TYPE, GetTextByLan("ÆØ¹âÀàÐÍ","Exposure Type"));
...
void Cls_ItsPictureCommon1::UI_UpdateAutoSetDialog()
{
	...
	int iType = m_cboType.GetItemData(m_cboType.GetCurSel());
...
BOOL Cls_ItsPictureCommon1::UI_UpdateTimeRangeParam()
{
	...
	pb.iTemplateIndex = iTimeRangeIndex;
	pb.iType = iType;
	pb.iExposalType = m_cboExposalType.GetCurSel();
	...
	if (0 == iRet)
	{
		m_cboAutoEnable.SetCurSel(pb.iAutoEnable);
		SetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1, pb.iParam1);
		SetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2, pb.iParam2);
		SetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM3, pb.iParam3);
		SetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM4, pb.iParam4);
...
void Cls_ItsPictureCommon1::OnBnClickedButtonParam()
{
	...
	pb.iTemplateIndex = iTimeRangeIndex;
	pb.iType = iType;
	pb.iAutoEnable = iAUTOEnable;
	pb.iExposalType = m_cboExposalType.GetCurSel();
	
	if((CAMERA_PARA_IRIS_ADJUSTMENT == iType) && (HAND_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 > PARAM_LIMIT26) || (pb.iParam1 < PARAM_LIMIT0))
		{
			MessageBox("param error!");
				return;
		}
	}
	else if((CAMERA_PARA_IRIS_ADJUSTMENT == iType) && (AUTO_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 > PARAM_LIMIT1) || (pb.iParam1 < PARAM_LIMIT0))
		{
		...
		if(pb.iParam1 == 1)
		{
			pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		}
	}
	else if(CAMERA_PARA_WDR == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 > PARAM_LIMIT2) || (pb.iParam1 < PARAM_LIMIT0))
		{
			MessageBox("param1 error!");
			return;
		}
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		if((pb.iParam2 > PARAM_LIMIT255) || (pb.iParam2 < PARAM_LIMIT0))
		{
			MessageBox("param2 error!");
			return;
		}
	}
	else if(CAMERA_PARA_BLC == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 > PARAM_LIMIT1) || (pb.iParam1 < PARAM_LIMIT0))
		{
		...
		{
			pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
			if((pb.iParam2 < PARAM_LIMIT1) || (pb.iParam2 > PARAM_LIMIT3))
			{
				MessageBox("param2 error!");
				return;
			}
	...
	else if((CAMERA_PARA_EXPOSURE_TIME == iType) && (HAND_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
	}
	else if((CAMERA_PARA_EXPOSURE_TIME == iType) && (AUTO_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		pb.iParam3 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM3);
	}
	else if((CAMERA_PARA_SHUTTER_ADJUSTMENT == iType) && (HAND_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 < PARAM_LIMIT0) || ((pb.iParam1 > PARAM_LIMIT47) && (pb.iParam1 < PARAM_LIMIT100)) || (pb.iParam1 > PARAM_LIMIT115))
		{
			MessageBox("param error!");
			return;
		}
	}
	else if((CAMERA_PARA_SHUTTER_ADJUSTMENT == iType) && (AUTO_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		pb.iParam3 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM3);
	}
	else if((CAMERA_PARA_GAIN_ADJUSTMENT == iType) && (HAND_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 < PARAM_LIMIT0) || (pb.iParam1 > PARAM_LIMIT255))
		{
			MessageBox("param error!");
			return;
		}
	}
	else if((CAMERA_PARA_GAIN_ADJUSTMENT == iType) && (AUTO_DO == iAUTOEnable))
	{	
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		pb.iParam3 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM3);
	}
	else if((CAMERA_PARA_GAMMA_ADJUSTMENT == iType) && (HAND_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		pb.iParam3 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM3);
		if((pb.iParam3 < PARAM_LIMIT0) || (pb.iParam3 > PARAM_LIMIT255))
		{
			MessageBox("param3 error!");
			return;
		}
	}
	else if((CAMERA_PARA_GAMMA_ADJUSTMENT == iType) && (AUTO_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		if((pb.iParam2 > PARAM_LIMIT0) || (pb.iParam2 < PARAM_LIMIT0))
		{
			MessageBox("param2 error!");
			return;
		}
	}
	else if((CAMERA_PARA_SHARPNESS_ADJUSTMENT == iType) && (HAND_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 < PARAM_LIMIT0) || (pb.iParam1 > PARAM_LIMIT255))
		{
	...
	else if((CAMERA_PARA_SHARPNESS_ADJUSTMENT == iType) && (AUTO_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		if((pb.iParam2 > PARAM_LIMIT1) || (pb.iParam2 < PARAM_LIMIT0))
		{
			MessageBox("param error!");
			return;
		}
	}
	else if((CAMERA_PARA_NOISE_REDUCTION_ADJUSTMENT == iType) && (HAND_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
	}
	else if((CAMERA_PARA_NOISE_REDUCTION_ADJUSTMENT == iType) && (AUTO_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
	}
	else if((CAMERA_PARA_NOISE_REDUCTION_ADJUSTMENT == iType) && (EXPERT_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 < PARAM_LIMIT0) || (pb.iParam1 > PARAM_LIMIT5))
		{
			MessageBox("param1 error!");
			return;
		}
	...
	else if(CAMERA_PARA_EXPOSURE_REGION == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		pb.iParam3 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM3);
		pb.iParam4 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM4);
	}
	else if(CAMERA_PARA_BLC_REGION == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		pb.iParam3 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM3);
	...
	else if(CAMERA_PARA_AF_REGION_SET == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		pb.iParam3 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM3);
	...
	else if(CAMERA_PARA_TARGET_BRIGHTNESS_ADJUSTMENT == iType)
	{
	...
	else if((CAMERA_PARA_WHITE_BALANCE_ADJUSTMENT == iType) && (HAND_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 < PARAM_LIMIT0) || (pb.iParam1 > PARAM_LIMIT255))
		{
		...
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		if((pb.iParam2 < PARAM_LIMIT0) || (pb.iParam2 > PARAM_LIMIT255))
		{
			MessageBox("param2 error!");
			return;
		}
		...
		pb.iParam4 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM4);
		if((pb.iParam4 < PARAM_LIMIT0) || (pb.iParam4 > PARAM_LIMIT1))
		{
	...
	else if((CAMERA_PARA_WHITE_BALANCE_ADJUSTMENT == iType) && (AUTO_DO == iAUTOEnable))
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 < PARAM_LIMIT100) || (pb.iParam1 > PARAM_LIMIT200))
		{
			MessageBox("param1 error!");
			return;
		}
		pb.iParam1 = pb.iParam1 / 5 * 5;
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		if((pb.iParam2 < PARAM_LIMIT100) || (pb.iParam2 > PARAM_LIMIT200))
		{
			MessageBox("param2 error!");
			return;
		}
		pb.iParam2 = pb.iParam2 / 5 * 5;
		pb.iParam3 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM3);
		if((pb.iParam3 < PARAM_LIMIT100) || (pb.iParam3 > PARAM_LIMIT200))
		{
			MessageBox("param3 error!");
			return;
		}
		pb.iParam3 = pb.iParam3 / 5 * 5;
		pb.iParam4 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM4);
		if((pb.iParam4 < PARAM_LIMIT0) || (pb.iParam4 > PARAM_LIMIT17))
		{
			MessageBox("param4 error!");
			return;
		}
	}
	else if(CAMERA_PARA_JPEG_IMAGE_QUALITY == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 < PARAM_LIMIT0) || (pb.iParam1 > PARAM_LIMIT100))
		{
			MessageBox("param1 error!");
			return;
		}
		pb.iParam2 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM2);
		if((pb.iParam2 < PARAM_LIMIT64) || (pb.iParam2 > PARAM_LIMIT8192))
		{
			MessageBox("param2 error!");
			return;
		}
	}
	else if(CAMERA_PARA_LUT_ENABLE == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 > PARAM_LIMIT1) || (pb.iParam1 < PARAM_LIMIT0))
		{
	...
	else if(CAMERA_PARA_AUTOMATIC_BRIGHTNESS_ADJUST == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 > PARAM_LIMIT1) || (pb.iParam1 < PARAM_LIMIT0))
		{
	...
	else if(CAMERA_PARA_HSBLC == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 > PARAM_LIMIT1) || (pb.iParam1 < PARAM_LIMIT0))
		{
	...
	else if(CAMERA_PARA_AUTO_EXPOSURE_MODE == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 < PARAM_LIMIT0) || (pb.iParam1 > PARAM_LIMIT6))
		{
			MessageBox("param error!");
			return;
		}
	}
	else if(CAMERA_PARA_SCENE_MODE == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 < PARAM_LIMIT0) || (pb.iParam1 > PARAM_LIMIT1))
		{
			MessageBox("param error!");
			return;
		}
	}
	else if(CAMERA_PARA_ANTI_FLASH == iType)
	{
		pb.iParam1 = GetDlgItemInt(IDC_EDIT_TIMERANGE_PARAM1);
		if((pb.iParam1 < PARAM_LIMIT0) || (pb.iParam1 > PARAM_LIMIT1))
		{
	...
	int iRet = NetClient_SetDevConfig(m_iLogonID, NET_CLIENT_HD_TIMERANGE_PARAMEX, m_iChannelNo, &pb, sizeof(pb));
	if (0 == iRet)
	{
		AddLog(LOG_TYPE_SUCC,"","NetClient_SetDevConfig NET_CLIENT_HD_TIMERANGE_PARAMEX(%d,%d)",m_iLogonID, m_iChannelNo);
	} 
	else
	{
		AddLog(LOG_TYPE_FAIL,"","NetClient_SetDevConfig NET_CLIENT_HD_TIMERANGE_PARAMEX(%d,%d), error(%d)",m_iLogonID,m_iChannelNo, GetLastError());
	}
}
...
void Cls_ItsPictureCommon1::OnEnChangeEditTimerangeParam1()
{
	...
	int iCheckSelect = m_cboType.GetItemData(m_cboType.GetCurSel());
