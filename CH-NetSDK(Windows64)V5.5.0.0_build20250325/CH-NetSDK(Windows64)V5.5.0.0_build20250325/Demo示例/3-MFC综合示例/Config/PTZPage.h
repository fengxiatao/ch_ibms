...
private:
	...
	CComboBox m_choSetPTZType;
	CComboBox m_choSetTempleID;
	CComboBox m_choGetTempleID;
	CComboBox m_choSetDevControl;
	CButton m_chkEnable;
...
public:
	...
	afx_msg void OnBnClickedButtonSetPtzSet();
	afx_msg void OnBnClickedButtonGetPtzGet();
	afx_msg void OnBnClickedButtonLensSet();
	afx_msg void OnBnClickedButtonLensGet();
	afx_msg void OnBnClickedButtonApertureOn();
	afx_msg void OnBnClickedButtonApertureOff();
	afx_msg void OnBnClickedButtonApertureGet();
	afx_msg void OnBnClickedButtonDevSet();
};
