...
private:
	CComboBox m_choSensorType;
	CSliderCtrl m_ScreenBright;
	CButton m_SwitchCtrl;
public:
	...
	void UI_UpdateHumitureScreen();

	afx_msg void OnBnClickedBtnHumTemThresholdSet();
	afx_msg void OnBnClickedButtonSet();
	afx_msg void OnNMCustomdrawSliderScreenBright(NMHDR *pNMHDR, LRESULT *pResult);
	afx_msg void OnBnClickedRadioSwitchctrl();
	afx_msg void OnBnClickedButtonStsyemSet();
