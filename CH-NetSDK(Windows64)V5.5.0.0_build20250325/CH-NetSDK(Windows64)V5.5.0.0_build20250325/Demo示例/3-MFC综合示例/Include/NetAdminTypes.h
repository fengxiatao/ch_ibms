...
#define TYPE_SMS_200        13    //Linux streaming host
#define TYPE_ALARM_HOST42   14    //Network alarm host
#define TYPE_TC_T820GE      15    //External trigger bayonet
#define TYPE_TC_T860GE      16    //Pure video card
#define TYPE_TC_T890GE      17    //External trigger electronic pan/tilt
