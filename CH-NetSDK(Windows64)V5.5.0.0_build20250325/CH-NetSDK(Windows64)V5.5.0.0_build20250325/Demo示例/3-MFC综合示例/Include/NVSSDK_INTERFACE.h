...
namespace NVSSDK_INTERFACE
{
	...
	TYPEDEF_FUNCTION(NetClient_GetRealPlayerIndex)(unsigned int* );
	DECLARE_FUNCTION(NetClient_GetRealPlayerIndex);
	...
	typedef int (__stdcall *pfNetClient_SycVoiceTalkInputData)(NetVoiceTalkInput* _pvPara, int _iSize);
	extern pfNetClient_SycVoiceTalkInputData NetClient_SycVoiceTalkInputData /*= 0*/;
	...
	//2009-4-21 - Railway Project --start
	...
	extern pfNetClient_SetATMConfig NetClient_SetATMConfig;//ATM related

	typedef int (__stdcall *pfNetClient_GetATMConfig)(int _iLogonID,int _iCmd, void* _lpBuf);
	extern pfNetClient_GetATMConfig NetClient_GetATMConfig;//ATM related
	...
	DECLARE_FUNCTION(NetClient_NetFileLockFile);//File lock
	...
	TYPEDEF_FUNCTION(NetClient_XmlSetDevConfig)(int _iLogonID, int _iCmd, void* _pvInPara, int _iInSize, void* _pvOutRet, int _iOutSize);
	DECLARE_FUNCTION(NetClient_XmlSetDevConfig);

	TYPEDEF_FUNCTION(NetClient_XmlGetDevConfig)(int _iLogonID, int _iCmd, void* _pvInPara, int _iInSize, void* _pvOutRet, int _iOutSize);
	DECLARE_FUNCTION(NetClient_XmlGetDevConfig);

	TYPEDEF_FUNCTION(NetClient_PlayerControl)(unsigned int _uiRecvID, int _iCmd, void* _pvCmdBuf, int _iBufLen, void* _pvUsrData);
	DECLARE_FUNCTION(NetClient_PlayerControl);

	TYPEDEF_FUNCTION(NetClient_SetSDKInitConfig)(int _iCmd, void *_lpInBuffer, int _iInBufferSize);
	DECLARE_FUNCTION(NetClient_SetSDKInitConfig);

	TYPEDEF_FUNCTION(NetClient_XmlCmdConfig)(int _iLogonID, int _iCmd, void* _pvInPara, int _iInSize, void* _pvOutRet, int _iOutSize);
	DECLARE_FUNCTION(NetClient_XmlCmdConfig);

	TYPEDEF_FUNCTION(NetClient_GetPlayerIndex)(unsigned int _uiConID);
	DECLARE_FUNCTION(NetClient_GetPlayerIndex);

	TYPEDEF_FUNCTION(NetClient_SetSrcRect)(unsigned int _ulID, void* _pSrcRect);
	DECLARE_FUNCTION(NetClient_SetSrcRect);

	TYPEDEF_FUNCTION(NetClient_SetDzTransparentPara)(int _iLogonID, void* _pvParaBuf, int _iBufSize, bool _blSync, bool _blTranscoding);
	DECLARE_FUNCTION(NetClient_SetDzTransparentPara);

	TYPEDEF_FUNCTION(NetClient_GetDzTransparentPara)(int _iLogonID, void* _pvParaBuf, int _iBufSize, bool _blSync, bool _blTranscoding);
	DECLARE_FUNCTION(NetClient_GetDzTransparentPara);

	TYPEDEF_FUNCTION(NetClient_InputTalkingdataEx)(int _iLogonID, unsigned char* _ucData, unsigned int _iLen);
	DECLARE_FUNCTION(NetClient_InputTalkingdataEx);
}
#endif
