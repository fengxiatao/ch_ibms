...
namespace NVSSDK_INTERFACE
{
	...
	pfNetClient_SycVoiceTalkInputData NetClient_SycVoiceTalkInputData = NULL;
	...
	IMPLEMENT_FUNCTION(NetClient_NetFileLockFile);//file lock
	...
	IMPLEMENT_FUNCTION(NetClient_Upgrade_V4);//Modify the file upgrade incompatibility problem
	...
	IMPLEMENT_FUNCTION(NetClient_XmlSetDevConfig);
	IMPLEMENT_FUNCTION(NetClient_XmlGetDevConfig);
	IMPLEMENT_FUNCTION(NetClient_PlayerControl);
	IMPLEMENT_FUNCTION(NetClient_SetSDKInitConfig);
	IMPLEMENT_FUNCTION(NetClient_XmlCmdConfig);
	IMPLEMENT_FUNCTION(NetClient_GetPlayerIndex);
    IMPLEMENT_FUNCTION(NetClient_SetSrcRect);
	IMPLEMENT_FUNCTION(NetClient_SetDzTransparentPara);
	IMPLEMENT_FUNCTION(NetClient_GetDzTransparentPara);
	IMPLEMENT_FUNCTION(NetClient_InputTalkingdataEx);
    ...
    int LoadNVSSDK(const char* _pszPath)
	{
		...
		NetClient_SycVoiceTalkInputData  =    (pfNetClient_SycVoiceTalkInputData)GetProcAddress(hNVSSDK, "NetClient_SycVoiceTalkInputData");
...
//        NetClient_EZoomReset = (pfNetClient_EZoomReset)GetProcAddress(hNVSSDK, "NetClient_EZoomReset");
      ...
      /*  EXPORT_FUNCTION(hNVSSDK, NetClient_SetITSTimeRangeParam);
		...
		EXPORT_FUNCTION(hNVSSDK, NetClient_NetFileLockFile);//file lock
		...
		EXPORT_FUNCTION(hNVSSDK, NetClient_Upgrade_V4);//The file upgrade is unified into one interface to solve the incompatibility problem
		...
		EXPORT_FUNCTION(hNVSSDK, NetClient_XmlSetDevConfig);
		EXPORT_FUNCTION(hNVSSDK, NetClient_XmlGetDevConfig);
		EXPORT_FUNCTION(hNVSSDK, NetClient_PlayerControl);
		EXPORT_FUNCTION(hNVSSDK, NetClient_SetSDKInitConfig);
		EXPORT_FUNCTION(hNVSSDK, NetClient_XmlCmdConfig);
		EXPORT_FUNCTION(hNVSSDK, NetClient_GetPlayerIndex);
		EXPORT_FUNCTION(hNVSSDK, NetClient_SetSrcRect);
		EXPORT_FUNCTION(hNVSSDK, NetClient_SetDzTransparentPara);
		EXPORT_FUNCTION(hNVSSDK, NetClient_GetDzTransparentPara);
		EXPORT_FUNCTION(hNVSSDK, NetClient_InputTalkingdataEx);
