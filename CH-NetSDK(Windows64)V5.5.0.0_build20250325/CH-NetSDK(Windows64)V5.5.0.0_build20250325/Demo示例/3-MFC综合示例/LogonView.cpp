...
BOOL CLS_LogonView::OnInitDialog()
{
	...
	SetDlgItemTextEx(IDC_STATIC_PLATFEATURE,IDS_PLATFEATURE);
	...
	SetDlgItemText(IDC_EDIT_PLATFEATURE,m_tDevice.cPlatFeature);
	GetDlgItem(IDC_EDIT_PLATFEATURE)->ShowWindow(SW_HIDE);
	GetDlgItem(IDC_STATIC_PLATFEATURE)->ShowWindow(SW_HIDE);

	CEdit* pEdit = NULL;
	pEdit = (CEdit*)GetDlgItem(IDC_EDIT_IP);
	...
	pEdit->SetLimitText(32);
	pEdit = (CEdit*)GetDlgItem(IDC_EDIT_PLATFEATURE);
	pEdit->SetLimitText(32);
	if (0 == m_iMode)
	{
...
void CLS_LogonView::OnBnClickedBtnLogon()
{
	...
	GetDlgItemText(IDC_EDIT_PLATFEATURE,m_tDevice.cPlatFeature,sizeof(m_tDevice.cPlatFeature));
...
void CLS_LogonView::OnNcLButtonDblClk(UINT nHitTest, CPoint point)
{
	// TODO: Add your message handler code here and/or call default
	GetDlgItem(IDC_EDIT_PLATFEATURE)->ShowWindow(SW_SHOW);
	GetDlgItem(IDC_STATIC_PLATFEATURE)->ShowWindow(SW_SHOW);
