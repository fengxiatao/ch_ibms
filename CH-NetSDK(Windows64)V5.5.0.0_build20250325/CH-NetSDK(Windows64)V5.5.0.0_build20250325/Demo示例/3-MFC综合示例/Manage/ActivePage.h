...
public:
	...
	static int __stdcall NvsLstNotify(int _iTotalCount, int _iCurrentCount, void* _pvNvsList, int _iTotalSize, int _iSingleSize, void* _pvUsrData);
	void AddOneNvsItem(DsmNvsRegInfoEx* _ptNvs);
	void UpdateDevLstByLocalServer();
#ifdef REGISTER_CALLBACK
	static void __stdcall DsmNvsRegisterNotify(DsmNvsRegInfo* _pNvsInfo, int _iSize, void* _pUser);
#endif
private:
	...
	static HWND s_hWnd;
	CEdit m_edtLocalWanIpV6;
	CEdit m_edtRegisterIpV6;
	CButton m_chkIpV6WithReg;
};
