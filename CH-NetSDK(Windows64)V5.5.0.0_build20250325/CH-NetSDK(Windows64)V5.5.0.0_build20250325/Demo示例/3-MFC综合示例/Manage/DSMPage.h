...
public:
	...
	void NslookLogonRegisterServer();
	void NvssdkLogonRegisterServer();
	afx_msg void OnBnClickedBtnServerVersion();
	
private:
	CButton m_chkUseNslook;
public:
	afx_msg void OnBnClickedCheckUseNslook();
	void UpdateRegisterInfo();
private:
	CButton m_chkIpV6;
public:
	afx_msg void OnBnClickedCheckDsmIpv6();
};
