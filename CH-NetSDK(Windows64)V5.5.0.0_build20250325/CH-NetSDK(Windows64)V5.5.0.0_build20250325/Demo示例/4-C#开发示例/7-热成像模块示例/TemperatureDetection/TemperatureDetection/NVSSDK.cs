...
namespace NVSSDK_INTERFACE
{
    class NVSSDK
    {
        ...
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetDevConfig(Int32 _iLogonID, Int32 _iCommand, Int32 _iChannel, IntPtr _lpOutBuffer, Int32 _iOutBufferSize, ref Int32 _lpBytesReturned);
        [DllImport("NVSSDK.dll")]
        ...
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_SetCommonEnable(Int32 _iLogonID, Int32 _iEnableID, Int32 _iChannel, Int32 _iEnableValue);
        }
}
