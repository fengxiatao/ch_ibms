...
namespace COMMON_STRUCT
{
    ...
    public struct CLIENTINFO
    {
        ...
        public int m_iPosition;		    //0~100, locate the file playback position; -1, do not locate
    ...
    public struct VcaPicStream
    {
        ...
        public IntPtr[]    tPicData; // Structure array definition   
    };

    public struct SnapPicData
    {
        public Int32 iSnapType;		//Snap type
        public Int32 iWidth;		//Picture wide
        public Int32 iHeight;		//Picture high
    ...
    public struct SnapPicStream
    {
        public Int32 iStructLen;	//Structure length
        public Int32 iPicCount;     //Record the number of images included
        public Int32 iSize;         //The size of strcut SnapPicData
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public IntPtr[] tSnapData;
    };
    ...
    public class SDKTypes
    {
        ...
        public const int NET_PICSTREAM_CMD_NORMALSNAP = 4;
    };
}