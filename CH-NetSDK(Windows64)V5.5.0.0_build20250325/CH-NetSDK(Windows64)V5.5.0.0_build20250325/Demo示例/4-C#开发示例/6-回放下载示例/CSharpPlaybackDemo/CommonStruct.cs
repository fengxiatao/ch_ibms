...
namespace PlaybackDemo
{
    ...
    public class NetSDKMsg
    {
        ...
        public const int WCM_VOD_STREAM_END = 141;
    ...
    public class NetSDKCmd
    {
        ...
        public const int DOWNLOAD_FILE_TYPE_ZFMP4 = 4;	//record MP4 stream
        public const int DOWNLOAD_FILE_TYPE_AVI = 5;	//record AVI stream
    }
