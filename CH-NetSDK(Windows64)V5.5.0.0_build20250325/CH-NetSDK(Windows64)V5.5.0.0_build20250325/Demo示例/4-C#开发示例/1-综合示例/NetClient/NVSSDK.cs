...
namespace NetClient
{
    ...
    {       
        ...
        public const int TYPE_CLIENT     = 2;       //Client to be connected
        public const int TYPE_TRANSFER   = 3;       //Video forwarding relationship
        public const int TYPE_ASSIGN     = 4;       //Agent assignment
        public const int TYPE_DNS        = 5;       //Domain name resolution
        public const int TYPE_DS         = 6;       //Secondary registry
        public const int TYPE_P2P_NVS    = 7;       //p2p nvs
        public const int TPYE_P2P_CLIENT = 8;       //Client using P2P connection
        ...
        private static extern Int32 GetControlCode_DOME_PLUS(Int32 _iAction, ref CONTROL_PARAM _cParam);
        ...
        public static Int32 NetClient_GetControlCode(string strDevType,Int32 _iAction, ref CONTROL_PARAM _cParam)
        {
            ...
            {
                return GetControlCode_DOME_PLUS(_iAction, ref _cParam);
            }
    ...
    class PLAYSDK
    {
        ...
        [DllImport("playsdkm4.dll")]
        public static extern Int32 TC_Stop(Int32 _iID);//Stop playback
	    [DllImport("playsdkm4.dll")]
        public static extern Int32 TC_DeletePlayer(Int32 _iID);//Delete the player instance
        [DllImport("playsdkm4.dll")]
