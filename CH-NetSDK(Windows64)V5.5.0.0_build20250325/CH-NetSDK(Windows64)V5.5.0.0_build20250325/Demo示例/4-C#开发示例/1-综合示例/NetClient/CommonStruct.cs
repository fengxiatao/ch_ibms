...
namespace NetClient
{
    ...
    struct DOWNLOAD_FILE
    {
        ...
        public char[] m_cRemoteFilename;   //Front-end video file name
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 255)]
        public char[] m_cLocalFilename;	  //local video file name
        public Int32 m_iPosition;		//When the file is positioned, according to the percentage 0~100; when the breakpoint resumes, the requested file pointer offset
        public Int32 m_iSpeed;			//1, 2, 4, 8, control file playback speed, 0-pause
        public Int32 m_iIFrame;			//Only send I frame 1, only play I frame; 0, play all
        public Int32 m_iReqMode;			//Mode of required data 1, frame mode; 0, stream mode
        public Int32 m_iRemoteFileLen;	//	If the local file name is not empty, this parameter is set to empty
    };
    [StructLayout(LayoutKind.Sequential)]
    ...
    {
        public Int32 m_iSize;			//structure size
        public Int32 m_iPosition;		//0~100, locate the file playback position; -1, no positioning
        public Int32 m_iSpeed;			//1, 2, 4, 8, control file playback speed, 0-pause
        public Int32 m_iIFrame;			//Only send I frame 1, only play I frame; 0, play all
        public Int32 m_iReqMode;			//Mode of required data 1, frame mode; 0, stream mode
    };
    ...
    struct NVS_FILE_QUERY
    {
        ...
        public int m_iDevType;       /* device type, 0-camera 1-network video server 2-network camera 0xff-all*/
    };
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct CLIENTINFO
    {
        ...
        public int m_iPosition;		//0~100, locate the file playback position; -1, no positioning
    ...
    struct STR_VideoParam
    {
        ...
        public UInt16 m_ustContrast;               //Contrast
    ...
    struct FTP_SNAPSHOT
    {
        ...
        public Int32 iEnable;			// Mode 0: Disable, 1: Enable (timed), 2: (Alarm linkage snapshot), 3: Alarm linkage multiple snapshot comments, the default is 2
        public Int32 iQValue;			// Image quality value range 0-100
        public Int32 iInterval;			// Capture time interval, the value range is 1-3600 (seconds)
        public Int32 iPictureSize;		// The size of the captured picture 0x7fff: means automatic, the rest correspond to the resolution size
    };
    ...
    struct VCA_TRuleParam_Tripwire
    {
        ...
        public Int32 iTripwireDirection;		//(0~359degree)
    ...
    // The SDK4.0 callback interface delegates the V4 interface as - __CDECL call
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    delegate void PARACHANGE_NOTIFY_V4(Int32 _ulLogonID, Int32 _iChan, Int32 _iParaType, IntPtr _strPara, Int32 _iUser);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    ...
    {
        public const int ALARM_VDO_MOTION	=	0;  //Motion detection
        ...
        public const int ALARM_AUDIO_LOST	=	7;  //Audio lost
        public const int ALARM_EXCEPTION    =   8;  
                                           
    }

    public class ParamChangeConstMsgType
    {
        public const int PARA_VCA_ALARMSTAT = 135;
        public const int PARA_IRRIGATION_NOTIFY = 573;  
    }

    //connect mode
    public class ConnectNetMode
    {
        public const int NETMODE_TCP = 1;
        public const int NETMODE_UDP = 2;
        public const int NETMODE_MC = 3;
        public const int RTP_OVER_TCP = 6;
        public const int RTP_OVER_UDP = 7;
        public const int RTP_OVER_MCAST = 8;
        public const int SRTP_OVER_UDP = 9;
        public const int SRTP_OVER_MCAST = 10;
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    struct IrrigationPara
    {
        public int iSize;
        public int iType;              //Irrigation type 1: rainfall;2: rainfall duration;3:water level;4:water depth;5:over warning water level value;6:flow velocity;7:remaining battery power;8:air pressure;9:wind speed;10:wind direction;11: temperature;12:humidity;13:pH;14:dissolved oxygen;15:redox;16:GPS;17:elevation;18:turbidity;19:ammonia nitrogen;20:water temperature;21:conductivity;22:chemical requirement oxygen;23:total nitrogen;24:total phosphorus;25:flow field;
        ...
        public IrrigationPara8 tIrriParam8;        //Param8  when the type is flowspeed,this para represents cruise times;when the type is WaterLevel, it represents if data is valid
        public IrrigationPara9 tIrriParam9;        //Param9  when the type is flowspeed,this para represents cruise times;when the type is WaterLevel, it represents if data is valid
        ...
        //[MarshalAs(UnmanagedType.ByValArray, SizeConst = 128)]
        //public byte[] cFactoryID;    //Param14 Device ID, no more than 64 bytes
        public int iIrriParam6;        //Param6  when iType=25,means detection area number
        public int iIrriParam13;       //Param13 when iType=25,means pixel termination abscissa
        public int iIrriParam15;       //Param15 when iType=25,means pixel termination ordinate
        public int iIrriParam16;       //Param16 when iType=25,means start abscissa of space point
        ...
        public int iIrriParam19;       //Param19 when iType=25,means Termination ordinate of space point
    ...
    struct IrrigationPara8
    {
        //[FieldOffset(0)]
        //public Int32 iWaterLevel;
        //[FieldOffset(1)]
        //public Int32 iRtxData;
        //[FieldOffset(2)]
        //public Int32 iCommonData;
    ...
    [StructLayout(LayoutKind.Sequential)]
    //[StructLayout(LayoutKind.Explicit, Size = 3)]
    struct IrrigationPara9
    {
        //[FieldOffset(0)]
        public Int32 iValid;
        //[FieldOffset(1)]
        public Int32 iCruiseNum;
        //[FieldOffset(2)]
        public Int32 iCommonData;
