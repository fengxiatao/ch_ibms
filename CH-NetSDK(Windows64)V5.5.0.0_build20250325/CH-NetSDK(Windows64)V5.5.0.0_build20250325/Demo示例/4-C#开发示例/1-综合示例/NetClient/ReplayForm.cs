...
namespace NetClient
{
    public partial class ReplayForm : BaseForm
    {
        ...
        private void Update_UI_Query_Result()
        {
            ...
            for (int i = 0; i < m_iCurrentCount; i++)
            {
                ...
                else
                {
                    ...
                    one.SubItems.Add(stime);
                    one.SubItems.Add("");  // Reserve to increase download progress
        ...
        private void btnDownload_Click(object sender, EventArgs e)
        {
	        ...
	        if (iRet >= 0)
	        {
		        //int iRet = NetClient_NetFileDownloadFile(&iConnID, m_iLogonID, (char *)(LPCSTR)m_szFileName, (char *)(LPCSTR)(g_szDownloadPath + m_szFileName), 1, -1, 16);//Set the download speed to 32 times
        ...
        private void btnStop_Click(object sender, EventArgs e)
        {
            ...
            if (IsFileInList(m_iLogonID, sFileName, ref iConnID))
	        {
             ...
             // If there is no downloaded file, stop the Timer update progress
