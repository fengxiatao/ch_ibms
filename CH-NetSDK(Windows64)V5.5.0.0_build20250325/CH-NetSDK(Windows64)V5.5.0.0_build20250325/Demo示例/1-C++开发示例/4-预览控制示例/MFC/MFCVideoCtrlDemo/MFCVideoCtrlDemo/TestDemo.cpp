// TestDemo.cpp : Defines the class behavior of the application.
//
...
// The only one CTestDemoApp object
...
BOOL CTestDemoApp::InitInstance()
{
	...
	// Since the dialog is closed, will return FALSE to exit the application,
