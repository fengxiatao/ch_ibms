...
#define	ERROR_INNER_XMLCHAN_EMPTY		(USER_ERROR+0x56)	//内部XmlChan空
#define ERROR_INNER_ENCAPXML_FAILED		(USER_ERROR+0x57)	//内部封装xml协议失败
#define ERROR_INNER_DEALXML_FAILED		(USER_ERROR+0x58)	//内部解析xml协议失败
#define ERROR_ACTIVE_SENDXML_FAILED		(USER_ERROR+0x59)	//主动模式发送xml请求失败
#define ERROR_ACTIVE_RECVXML_TIMEOUT	(USER_ERROR+0x60)	//主动模式发送xml请求等待设备回复超时
#define ERROR_START_TCP_SERVER			(USER_ERROR+0x61)	//创建代理时失败
#define ERROR_LOAD_LIBRARY				(USER_ERROR+0x62)	//加载库失败
