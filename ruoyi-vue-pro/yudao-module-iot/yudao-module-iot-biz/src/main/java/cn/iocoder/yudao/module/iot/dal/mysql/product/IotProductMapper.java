...
public interface IotProductMapper extends BaseMapperX<IotProductDO> {
    ...
    /**
     * 查询所有配置了 jobConfig 的产品
     * 
     * @return 产品列表
     */
    default List<IotProductDO> selectProductsWithJobConfig() {
        return selectList(new LambdaQueryWrapper<IotProductDO>()
                .isNotNull(IotProductDO::getJobConfig)
                .ne(IotProductDO::getJobConfig, ""));
    }
