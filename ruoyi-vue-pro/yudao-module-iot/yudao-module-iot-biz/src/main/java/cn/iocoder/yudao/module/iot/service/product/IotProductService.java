...
public interface IotProductService {
     ...
     * 
     * @return 产品列表（包含 id 和 jobConfig 字段）
     */
    List<IotProductDO> getProductsWithJobConfig();
     ...
     */
    void updateProductJobConfig(Long id, String jobConfig);

    /**
     * 批量获取产品Map
     *
     * @param productIds 产品ID集合
     * @return 产品Map（key: 产品ID, value: 产品对象）
     */
    Map<Long, IotProductDO> getProductMap(Set<Long> productIds);
