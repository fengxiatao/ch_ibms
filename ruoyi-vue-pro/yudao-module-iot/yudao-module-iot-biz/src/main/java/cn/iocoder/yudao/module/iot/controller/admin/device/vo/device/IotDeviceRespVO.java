...
public class IotDeviceRespVO {
    ...
    @Schema(description = "实际生效的菜单ID列表（考虑继承）", example = "[1001, 1002, 1003]")
    private String effectiveMenuIds;

    @Schema(description = "实际生效的主要菜单ID（考虑继承）", example = "1001")
    private Long effectivePrimaryMenuId;

    @Schema(description = "菜单配置来源", example = "product")
    private String menuConfigSource; // "product" 或 "device"
    ...
    @Schema(description = "设备厂商", example = "Dahua")
    private String vendor;

    @Schema(description = "设备 IP 地址", example = "192.168.1.100")
    @ExcelProperty("设备 IP")
    private String ipAddress;

    @Schema(description = "设备 TCP 端口", example = "37777")
    @ExcelProperty("TCP 端口")
    ...
    @Schema(description = "楼层名称", example = "3层")
    private String floorName;

    @Schema(description = "区域名称", example = "会议室301")
