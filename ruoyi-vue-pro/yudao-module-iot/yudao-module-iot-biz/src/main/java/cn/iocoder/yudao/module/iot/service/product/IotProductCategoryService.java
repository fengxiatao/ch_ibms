...
public interface IotProductCategoryService {
     ...
     * @return 树形分类列表
     */
    List<IotProductCategoryDO> getProductCategoryTree();

    /**
     * 根据模块编码获取分类树
     *
     * @param moduleCode 模块编码（building/security/access/fire/energy）
     * @return 该模块下的分类树
     */
    List<IotProductCategoryDO> getProductCategoryTreeByModule(String moduleCode);
     ...
     * @return 子分类列表
     */
    List<IotProductCategoryDO> getChildCategories(Long parentId);
