...
public interface IotDevicePropertyService {
     ...
     * @param message 设备消息
     */
    void saveDeviceProperty(IbmsDeviceDO device, IotDeviceMessage message);
     ...
     */
    void saveDevicePropertyToTDengine(IbmsDeviceDO device, Map<String, Object> properties, LocalDateTime reportTime);
