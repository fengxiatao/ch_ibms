...
public enum IotDeviceMessageMethodEnum implements ArrayValuable<String> {
    ...
    ALARM_QUERY_RESPONSE("alarm.query.response", "报警主机状态查询响应", true),
    ;
    ...
    public static final Set<String> REPLY_DISABLED = SetUtils.asSet(
            "thing.state.update",
            "thing.ota.progress", // 参考阿里云，OTA 升级进度上报，不进行回复
            "alarm.query.response" // 报警主机状态查询响应，不进行回复
    );
