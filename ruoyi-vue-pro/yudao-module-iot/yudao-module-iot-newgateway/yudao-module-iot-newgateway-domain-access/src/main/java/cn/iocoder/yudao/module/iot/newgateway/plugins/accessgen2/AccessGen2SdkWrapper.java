...
import cn.iocoder.yudao.module.iot.newgateway.plugins.accessgen2.adapter.AccessGen2BrandHints;
...
public class AccessGen2SdkWrapper implements AccessGen2VendorAdapter {

    private static final String LOG_PREFIX = "[AccessGen2SdkWrapper]";

    /** 与 {@link cn.iocoder.yudao.module.iot.newgateway.plugins.accessgen2.adapter.AccessGen2AdapterFactory} 默认适配器一致 */
    ...
    @Override
    public void registerDisconnectListener(AccessGen2VendorAdapter.DisconnectCallback listener) {
        if (listener == null) {
            return;
        }
        addDisconnectListener(listener::onDisconnect);
    }
