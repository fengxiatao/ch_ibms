...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("长辉信息科技有限公司");
        ...
        desensitizeDemo.setRegex("你好，我是长辉信息科技有限公司");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("长辉信息科技有限公司");
        ...
        assertEquals("长辉信息科技有限公司", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "长辉信息科技有限公司", replacer = "*")
