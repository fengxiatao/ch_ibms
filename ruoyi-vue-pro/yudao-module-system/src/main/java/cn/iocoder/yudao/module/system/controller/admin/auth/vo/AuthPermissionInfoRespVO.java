...
public class AuthPermissionInfoRespVO {
    ...
    public static class UserVO {
        ...
        @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "长辉信息科技有限公司")
        private String nickname;

        @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.changhui-tech.com/xx.jpg")
        ...
        @Schema(description = "用户邮箱", example = "yudao@changhui-tech.com")
