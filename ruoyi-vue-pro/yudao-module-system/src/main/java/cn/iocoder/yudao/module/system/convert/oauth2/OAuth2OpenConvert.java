...
import cn.iocoder.yudao.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO.ScopeKV;
...
public interface OAuth2OpenConvert {
    ...
    default OAuth2OpenAuthorizeInfoRespVO convert(OAuth2ClientDO client, List<OAuth2ApproveDO> approves) {
        // 构建 scopes
        List<ScopeKV> scopes = new ArrayList<>(client.getScopes().size());
        ...
        client.getScopes().forEach(scope -> {
            ...
            scopes.add(new ScopeKV(scope, approve != null ? approve.getApproved() : false));
        });
        // 拼接返回
