...
public interface OperateLogMapper extends BaseMapperX<OperateLogDO> {
    ...
    default PageResult<OperateLogDO> selectPage(OperateLogPageReqVO pageReqDTO) {
        ...
        com.baomidou.mybatisplus.extension.plugins.pagination.Page<OperateLogDO> mpPage =
                new com.baomidou.mybatisplus.extension.plugins.pagination.Page<>(pageReqDTO.getPageNo(), pageReqDTO.getPageSize());
